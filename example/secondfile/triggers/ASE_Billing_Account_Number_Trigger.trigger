trigger ASE_Billing_Account_Number_Trigger on ASE_Billing_Account_Number__c (after delete, after insert, after undelete, after update, 
    before delete, before insert, before update) {
  
  boolean isExecuted = false;
        SITriggerOperations.SITriggerImpl handler = new SITriggerDelegate().getHandlerHandleObject(SIConstants.ASE_Billing_Account_Number_TriggerHandler);
