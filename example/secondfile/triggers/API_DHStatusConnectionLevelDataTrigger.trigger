trigger API_DHStatusConnectionLevelDataTrigger on DHStatus_Connection_Level_Data__c (before insert, after insert,  
before update, after update, before delete, after delete, after undelete) {
  
    boolean isExecuted = false;
   SITriggerOperations.SITriggerImpl handler = new SITriggerDelegate().getHandlerHandleObject(SIConstants.DHStatusConnectionLevel_TRIG_HANDLER);
