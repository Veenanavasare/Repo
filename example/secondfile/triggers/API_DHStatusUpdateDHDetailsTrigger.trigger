trigger API_DHStatusUpdateDHDetailsTrigger on DHStatus_Update_Deal_Hash_Details__c (before insert, after insert,  
before update, after update, before delete, after delete, after undelete) {
  
    boolean isExecuted = false;
   SITriggerOperations.SITriggerImpl handler = new SITriggerDelegate().getHandlerHandleObject(SIConstants.DHStatusUpdate_TRIG_HANDLER);
