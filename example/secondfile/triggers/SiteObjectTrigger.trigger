/**
* Class/Trigger  Name: SiteObjectTrigger
* Author: Accenture
* Date: 28-Aug-2013
* Requirement # R-2339
* Description: This is the Trigger for Site object.
* Version History: V 1.0
*/

trigger SiteObjectTrigger on Site__c (after delete, after insert, after undelete, 
after update, before delete, before insert, before update) 
{
	boolean isExecuted = false;
 	SITriggerOperations.SITriggerImpl handler = new SITriggerDelegate().getHandlerHandleObject(SIConstants.SITE_TRIGGER_HANDLER);
