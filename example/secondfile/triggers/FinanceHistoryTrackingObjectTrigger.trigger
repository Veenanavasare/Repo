trigger FinanceHistoryTrackingObjectTrigger on Financing_history_tracking__c (after delete, after insert, after undelete, after update, 
    before delete, before insert, before update) {
  boolean isExecuted = false;
   SITriggerOperations.SITriggerImpl handler = new SITriggerDelegate().getHandlerHandleObject(SIConstants.Financing_History_Tracking_TRIG_HANDLER);
