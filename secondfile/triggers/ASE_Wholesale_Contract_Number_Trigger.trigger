trigger ASE_Wholesale_Contract_Number_Trigger on ASE_Wholesale_Contract_Number__c (after delete, after insert, after undelete, after update, 
    before delete, before insert, before update) {
   
        boolean isExecuted = false;
        SITriggerOperations.SITriggerImpl handler = new SITriggerDelegate().getHandlerHandleObject(SIConstants.ASE_Wholesale_Contract_Number_TriggerHandler);
