trigger API_DHStatus_AccessCircuit_Trigger on DHStatus_Access_Circuit_Data__c (after delete, after insert, after undelete, 
after update, before delete, before insert, before update) 
{
  
    boolean isExecuted = false;
   SITriggerOperations.SITriggerImpl handler = new SITriggerDelegate().getHandlerHandleObject(SIConstants.DHStatusAccessCircuit_TRIGGER_HANDLER);
