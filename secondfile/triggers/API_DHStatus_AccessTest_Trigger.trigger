trigger API_DHStatus_AccessTest_Trigger on DHStatus_Access_Test_Status_Details__c (after delete, after insert, after undelete, 
after update, before delete, before insert, before update) {
boolean isExecuted = false;
   SITriggerOperations.SITriggerImpl handler = new SITriggerDelegate().getHandlerHandleObject(SIConstants.DHStatusAccessTestStatus_TRIGGER_HANDLER);
