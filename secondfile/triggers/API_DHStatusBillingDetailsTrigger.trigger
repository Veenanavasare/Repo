trigger API_DHStatusBillingDetailsTrigger on DHStatus_Billing_Update_Details__c (after delete, after insert, after undelete, 
after update, before delete, before insert, before update) {
  
    boolean isExecuted = false;
   SITriggerOperations.SITriggerImpl handler = new SITriggerDelegate().getHandlerHandleObject(SIConstants.DHStatus_Billing_Update_Details_TRIGGER_HANDLER);
